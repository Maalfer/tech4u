            ...
            <main className="flex-1 ml-64 p-8">
                ...
                {!isSubscribed && !isStaff ? (
                    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center max-w-lg mx-auto">
                        ...
                        <p className="text-slate-400 font-mono text-sm mb-2 leading-relaxed">
                            El temario completo está disponible exclusivamente para miembros suscritos.
                        </p>
                        <p className="text-slate-500 font-mono text-xs mb-8">
                            Accede a Redes, SO, Bases de Datos, Hardware y más.
                        </p>
                        <Link
                            to="/suscripcion"
                            className="flex items-center gap-2 px-8 py-4 bg-amber-500 hover:bg-amber-400 text-black rounded-2xl font-black uppercase tracking-wider transition-all hover:scale-105 hover:shadow-[0_0_20px_rgba(245,158,11,0.4)] text-sm"
                        >
                            <CreditCard className="w-5 h-5" /> Ver Planes de Suscripción
                        </Link>
                        <p className="text-slate-600 font-mono text-[10px] mt-4 uppercase tracking-widest">
