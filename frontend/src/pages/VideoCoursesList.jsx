    ...
    return (
        <div className="flex min-h-screen bg-[#0D0D0D]">
            ...
            <main className="flex-1 ml-64 p-8 overflow-y-auto">
                ...
                <div className="mb-8">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#39FF14]/10 border border-[#39FF14]/30 mb-4">
                        <Video className="w-4 h-4 text-[#39FF14]" />
                        <span className="text-[#39FF14] font-mono text-xs uppercase tracking-widest font-bold">Aprende paso a paso</span>
                    </div>
                    <h1 className="text-4xl font-black text-white uppercase italic mb-2">
                        Cursos en <span className="text-[#39FF14]">Vídeo</span>
                    </h1>
                ...
                {courses.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {courses.map(course => (
                            <div key={course.id} className="bg-[#111] border border-slate-800 rounded-3xl overflow-hidden hover:border-[#39FF14]/50 transition-all duration-300 group flex flex-col">
                                ...
                                <div className="h-40 bg-gradient-to-br from-slate-800 to-black relative">
                                    ...
                                    <div className="absolute top-4 right-4 px-3 py-1 bg-black/80 backdrop-blur border border-white/10 rounded-full font-mono text-[10px] text-white flex items-center gap-1">
                                        <PlayCircle className="w-3 h-3 text-[#39FF14]" />
                                    ...
                                    <div className="space-y-4 mt-auto">
                                        ...
                                        <div>
                                            <div className="flex justify-between items-end mb-2">
                                                ...
                                                <span className="text-[10px] font-mono text-[#39FF14] font-bold">{course.progress_percentage}%</span>
                                            </div>
                                        ...
                                        <button
                                            ...
                                            className="w-full py-3 bg-white/5 border border-slate-700 text-white font-black font-mono text-xs uppercase tracking-wide rounded-xl group-hover:bg-[#39FF14] group-hover:text-black group-hover:border-[#39FF14] transition-all flex items-center justify-center gap-2"
                                        >
