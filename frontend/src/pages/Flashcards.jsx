    ...
    return (
        <div className="flex min-h-screen bg-[#050505] text-white selection:bg-orange-500/30">
            ...
            <main className="flex-1 ml-64 p-10 overflow-hidden relative">
                ...
                {/* Legend Header */}
                <header className="mb-16 flex justify-between items-end relative z-10">
                    <div className="animate-in fade-in slide-in-from-left duration-700">
                        <div className="flex items-center gap-5 mb-4">
                            <div className="relative group">
                                ...
                                <div className="p-4 bg-gradient-to-br from-orange-500/20 to-transparent rounded-2xl border-2 border-orange-500/30 shadow-[0_0_40px_rgba(255,165,0,0.1)] relative overflow-hidden backdrop-blur-xl">
                                    <Sword className="w-10 h-10 text-orange-500 group-hover:rotate-[15deg] transition-transform duration-500" />
                            ...
                            <div>
                                <h1 className="text-5xl font-black uppercase tracking-tighter italic leading-none text-transparent bg-clip-text bg-gradient-to-r from-white via-orange-100 to-orange-500 drop-shadow-sm">
                                    Quest<span className="text-white">Cards</span>
                                </h1>
                                <div className="flex items-center gap-2 mt-2">
                                    <div className="h-px w-8 bg-orange-500/50" />
                                    <p className="text-[10px] font-mono text-orange-500/70 uppercase tracking-[0.4em] font-black">Codex of Mastery</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-3 min-w-[280px] animate-in fade-in slide-in-from-right duration-700">
