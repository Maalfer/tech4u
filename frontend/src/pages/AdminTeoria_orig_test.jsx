...
const SUBJECT_STYLES = {
    'Examen General': { icon: FileText, isCustom: false, color: 'from-yellow-600/20 to-yellow-900/10 border-yellow-500/30 hover:border-yellow-400/60', iconColor: 'text-yellow-400', badge: 'bg-yellow-500/10 text-yellow-400 border-yellow-500/30' },
    'Bases de Datos': { icon: Database, isCustom: false, color: 'from-violet-600/20 to-violet-900/10 border-violet-500/30 hover:border-violet-400/60', iconColor: 'text-violet-400', badge: 'bg-violet-500/10 text-violet-400 border-violet-500/30' },
    'Redes': { icon: Wifi, isCustom: false, color: 'from-sky-600/20 to-sky-900/10 border-sky-500/30 hover:border-sky-400/60', iconColor: 'text-sky-400', badge: 'bg-sky-500/10 text-sky-400 border-sky-500/30' },
    'Sistemas Operativos': { icon: Monitor, isCustom: false, color: 'from-emerald-600/20 to-emerald-900/10 border-emerald-500/30 hover:border-emerald-400/60', iconColor: 'text-emerald-400', badge: 'bg-emerald-500/10 text-emerald-400 border-emerald-500/30' },
    'Fundamentos de Hardware': { icon: Cpu, isCustom: false, color: 'from-orange-600/20 to-orange-900/10 border-orange-500/30 hover:border-orange-400/60', iconColor: 'text-orange-400', badge: 'bg-orange-500/10 text-orange-400 border-orange-500/30' },
    'Lenguaje de Marcas': { icon: FileCode, isCustom: false, color: 'from-cyan-600/20 to-cyan-900/10 border-cyan-500/30 hover:border-cyan-400/60', iconColor: 'text-cyan-400', badge: 'bg-cyan-500/10 text-cyan-400 border-cyan-500/30' },
};
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-center gap-6 mb-6">
                                            ...
                                            <h3 className="text-xl font-black uppercase italic text-white leading-tight group-hover:text-white">
                                                {s.name}
                                            </h3>
                                        </div>
